...
import { MenuCategory, Lang, Supplement, Allergen, ALLERGEN_LABELS } from "@/data/menu";
...
const ALLERGEN_SVG: Record<string, React.ReactNode> = {
  glutine: (<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a10 10 0 00-3 19.5M12 2a10 10 0 013 19.5M12 2v20M2 12h20" /></svg>),
  latte: (<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 2h8l2 6v12a1 1 0 01-1 1H7a1 1 0 01-1-1V8L8 2z" /></svg>),
  uova: (<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="13" rx="7" ry="9" /></svg>),
  pesce: (<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7S2 12 2 12z" /><circle cx="12" cy="12" r="2" /></svg>),
  molluschi: (<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2C7 2 3 7 3 12s4 10 9 10 9-5 9-10S17 2 12 2z" /><path d="M12 8v8M8 12h8" /></svg>),
  frutta_a_guscio: (<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a7 7 0 017 7c0 5-7 13-7 13S5 14 5 9a7 7 0 017-7z" /></svg>),
  anidride_solforosa: (<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-3" /><path d="M18 2l4 4-10 10H8v-4L18 2z" /></svg>),
};
...
function AllergenBadge({ allergen, lang }: { allergen: Allergen; lang: Lang }) {
  ...
  return (
    <span style={{
      ...
      background: "rgba(11,92,173,0.08)", border: "1px solid rgba(11,92,173,0.18)",
      borderRadius: 5, padding: "2px 6px", fontSize: "0.7rem",
      fontFamily: "'Jost', sans-serif", fontWeight: 500,
      color: "#0B5CAD", whiteSpace: "nowrap",
    }}>
...
function SupplementsBox({ supplements, lang }: { supplements: Supplement[]; lang: Lang }) {
  return (
    <div style={{
      margin: "24px 0 0", borderRadius: 14,
      border: "1.5px solid rgba(11,92,173,0.2)",
      background: "rgba(11,92,173,0.04)", padding: "16px 14px",
    }}>
      <p style={{
        fontFamily: "'Cormorant Garamond', serif", fontSize: "1.2rem",
        fontWeight: 700, color: "#082B4F", marginBottom: 12, letterSpacing: "0.02em",
      }}>
        ...
        <div key={gi} style={{ marginBottom: 8 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            {group.items.map((item, ii) => {
              ...
              return (
                <div key={ii} style={{ padding: "14px 0", borderBottom: "1px solid rgba(8,43,79,0.07)", opacity: available ? 1 : 0.45 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                    <div style={{ flex: 1 }}>
                      <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.25rem", fontWeight: 600, color: "#082B4F", lineHeight: 1.25, marginBottom: desc ? 4 : 0, textDecoration: available ? "none" : "line-through" }}>
                        {name}
                      </p>
                      {desc && (
                    ...
                    {item.price != null && (
                      <span style={{ fontFamily: "'Jost', sans-serif", fontSize: "1.1rem", fontWeight: 600, color: available ? "#0B5CAD" : "#999", whiteSpace: "nowrap", paddingTop: 1 }}>
                        {fmtPrice(item.price)}
                      </span>
                    )}
                  </div>
